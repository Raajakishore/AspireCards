  ...
  return (
    <Tab.Navigator
        ...
        tabBarIcon: ({ focused, size }) => {
          switch (route.name) {
            case 'Home':
              return focused ? <HomeActiveTabIcon width={size} height={size} /> : <HomeInActiveTabIcon width={size} height={size} />;
            case 'Debit Card':
              return focused ? <DebitCardActiveTabIcon width={size} height={size} /> : <DebitCardInActiveTabIcon width={size} height={size} />;
            case 'Payments':
              return focused ? <PaymentsActiveTabIcon width={size} height={size} /> : <PaymentsInActiveTabIcon width={size} height={size} />;
            case 'Credit':
              return focused ? <CreditTabActiveIcon width={size} height={size} /> : <CreditTabInActiveTabIcon width={size} height={size} />;
            case 'Profile':
              return focused ? <ProfileActiveTabIcon width={size} height={size} /> : <ProfileInActiveTabIcon width={size} height={size} />;
          }
        },
      })}
    >
      <Tab.Screen name="Home" component={HomeTab} options={{ headerShown: false }}/>
      <Tab.Screen name="Debit Card" component={DebitCardTab} options={{ headerShown: false }}/>
      <Tab.Screen name="Payments" component={PaymentsTab} options={{ headerShown: false }}/>
      <Tab.Screen name="Credit" component={CreditTab} options={{ headerShown: false }}/>
