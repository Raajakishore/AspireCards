...
// Add a new card
function* addNewCardSaga(action: ReturnType<typeof addNewCardAction>) : SagaIterator {
  try {
...
function* updateCardDetailsSaga(action: ReturnType<typeof updateCardAction>) : SagaIterator {
  try {
